...
AI Tells is currently in early development. Security updates apply to the latest version only.
...
AI Tells requires **Python 3.13** or later.

## Reporting a vulnerability

If you discover a security vulnerability in AI Tells, please report it responsibly.
...
1. Go to the [Security tab](https://github.com/tbhb/aitells/security) of the repository
