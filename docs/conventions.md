...
This page explains patterns used throughout the AI Tells documentation.
...
Four sections organize the documentation based on your goals:

[Tutorials](tutorials/index.md)
:   Step-by-step lessons for learning AI Tells from scratch.
