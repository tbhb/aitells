...
dev-docs:
  ...
  if [ $port -gt $max_port ]; then
    echo "No available ports found between 8000 and $max_port"
    exit 1
  fi
...
lint-prose *args:
  vale {{ if args == "" { "docs/**/*.md CODE_OF_CONDUCT.md CONTRIBUTING.md README.md SECURITY.md" } else { args } }}
